...
Joystick.createPlugin = function() {
	...
	var ctrlFF = Utils.getMainWindow().getBrowser().selectedBrowser.contentWindow.document.createElement("embed");
	//alert(ctrlFF);
